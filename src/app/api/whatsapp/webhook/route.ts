...
// findOrCreateContact / findOrCreateConversation live in
// @/lib/channels/inbound-identity (shared with the Chatwoot webhook
// pipeline since migration 037) — same implementations, one home.
